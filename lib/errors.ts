...
export const ERROR_CATALOG = {
  ...
  invalid_key: { status: 401, message: "Invalid private key." },
  ...
  not_authenticated: { status: 401, message: "Your access has expired. Enter your private key again." },
  no_access: { status: 401, message: "This browser has no active identity. Enter your private key again." },
  ...
  price_unavailable: { status: 503, message: "Live XMR price is unavailable right now." },
